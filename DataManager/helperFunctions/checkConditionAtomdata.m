function outSatisfiers = checkConditionAtomdata(atomdata,var,condition) 
    %See which specified var satisfies the conditions given.  
    %
    ...
    varSpace=[atomdata.vars];
    
    %The property being checked is a number array
    if isnumeric(varSpace(1).(var))
